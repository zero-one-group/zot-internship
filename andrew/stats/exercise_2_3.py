...
uniform_distribution = [stats.uniform.rvs(loc = -0.5, scale = 1, size = 100000) for i in range(1, 13)]
...
uniform_distribution_1 = stats.uniform.rvs(size = 100000)
uniform_distribution_2 = stats.uniform.rvs(size = 100000)
...
normal_distribution = stats.norm.rvs(size = 100000)
plt.figure(1)
